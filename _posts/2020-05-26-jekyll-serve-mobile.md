...
%(image {:file "jekyll-connection-refused.png" :alt "connection refused" :caption "Connection refused" :class "tall"})
...
%(image {:file "jekyll-connection-success.jpg" :alt "success!" :caption "Success!" :class "tall"})
